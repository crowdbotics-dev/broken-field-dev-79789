"""
Django settings for broken_field_dev_79789 project.
...
ROOT_URLCONF = 'broken_field_dev_79789.urls'
...
WSGI_APPLICATION = 'broken_field_dev_79789.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "broken_field_dev_79789 API",
    "DESCRIPTION": "API documentation for broken_field_dev_79789 App",
    "VERSION": "v1",
}
